...
export default function Blogsbyid() {
    ...
    // Menggunakan useCallback untuk mencegah perubahan fungsi yang tidak diinginkan
    ...
    useEffect(() => {
        onFetchBlogs();
        onFetchKomentar();
    }, [onFetchBlogs, onFetchKomentar]); // Menambahkan fungsi ke dalam dependencies array
